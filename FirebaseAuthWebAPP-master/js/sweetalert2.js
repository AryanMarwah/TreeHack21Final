...
}(this, function ()
{
    ...
    var Be = function e(t, n)
    {
        ...
        Pe = {
            email: function (e, t)
            {
                return /^[a-zA-Z0-9.+_-]+@[a-zA-Z0-9.-]+\.[a-zA-Z0-9-]{2,24}$/.test(e) ? Promise.resolve() : Promise.reject(t && t.validationMessage ? t.validationMessage : "Geçersiz email adresi")
            },
            url: function (e, t)
            {
                return /^https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_+.~#?&//=]*)$/.test(e) ? Promise.resolve() : Promise.reject(t && t.validationMessage ? t.validationMessage : "Geçersiz URL")
            }
        };
    var Se = function (e)
    {
    ...
    var Ee, Oe = Object.freeze({
        ...
        _main: function (e)
        {
            ...
            return new Promise(function (t, n)
            {
                ...
                {
                    R("Hata in inputValue promise: " + e), d.value = "", z(d), d.focus(), L.hideLoading()
                }));
